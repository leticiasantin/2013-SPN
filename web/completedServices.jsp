...
<table border="1">
    <caption> Serviços Finalizados como Prestador </caption>
    <tr>
    ...
    <c:forEach var="comServ" items="${asProviderList}">
        <tr>
            ...
            <td>${comServ.service.clientName}</td>
        ...
        <tr id="more${comServ.service.serviceId}" hidden="hidden">
            <td colspan="3">
                <table>
                    <caption>Avaliação Cliente</caption>
                    <tr>
            ...
            <td colspan="3">
                <table>
                    <caption>Avaliação Prestador</caption>
                    <tr>
...
<div id="clientEvaluation">
    <table border="1">
    <caption> Serviços Finalizados como Cliente </caption>
    <tr>
        <th id="serviceId">Número do serviço</th>
        <th id="description">Descrição</th>
        <th id="clientRequestDat">Data de requisição</th>
